...
public class MovingBridge_Main : MonoBehaviour
{
    Animator m_bridgeAnimator;
    ...
    private void Start()
    {
        m_bridgeAnimator = GetComponent<Animator>();
    ...
    private void PlayAnimation()
    {
        ...
        m_bridgeAnimator.SetBool("IsRewind", isRewind); // 巻き戻しフラグをオフ
        m_bridgeAnimator.SetBool("IsPlaying", true); // 再生フラグをオン
    ...
    {
        // トリガーを設定
        m_bridgeAnimator.SetTrigger("Rewind");
    ...
    private void TriggerRewind()
    {
        ...
        m_bridgeAnimator.SetBool("IsPlaying", false); // 再生フラグをオフ
        m_bridgeAnimator.SetBool("IsRewind", isRewind); // 巻き戻しフラグをオン
        m_isPushButton = false; // フラグを戻す。
    }
}
