...
public class StageSelector_Prototype : MonoBehaviour
{
    /// <summary>
    /// ステージのステート。
    /// </summary>
    ...
    private readonly Vector3 START_POSITION = new Vector3(75.0f, -20.0f, -50.0f);
    private readonly Vector3 END_POSITION = new Vector3(-75.0f, -20.0f, -50.0f);
    ...
    private void SetStagePositions()
    {
        ...
        for (int i = 0; i < m_stageObjects.Length; i++)
        {
            if (i == 0)
            {
                ...
                m_movePositions[i] = new Vector3(0.0f, -20.0f, -75.0f);
            }
            else
            {
                //それ以外のポジション
